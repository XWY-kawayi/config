...
> Integrate by [blackmatrix7](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule)
...
# Line规则
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Line/Line.list, tag=Line规则, force-policy=Line, update-interval=86400, opt-parser=false, enabled=true
# Google规则
